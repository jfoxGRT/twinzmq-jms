...
@Component
public class NewQuoteMessageListener5 implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		if(message instanceof TextMessage) {
			...
			if(quoteObj != null){
				try{
					log.debug("From CONSUMER 5, saving: " + quoteObj);
					quoteObj.setQuoteText("CONSUMER 5: " + quoteObj.getQuoteText());
