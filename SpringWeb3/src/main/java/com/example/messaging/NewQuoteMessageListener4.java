...
@Component
public class NewQuoteMessageListener4 implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		if(message instanceof TextMessage) {
			...
			if(quoteObj != null){
				try{
					log.debug("From CONSUMER 4, saving: " + quoteObj);
					quoteObj.setQuoteText("CONSUMER 4: " + quoteObj.getQuoteText());
