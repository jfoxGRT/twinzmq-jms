...
@Component
public class NewQuoteMessageListener6 implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		if(message instanceof TextMessage) {
			...
			if(quoteObj != null){
				try{
					log.debug("From CONSUMER 6, saving: " + quoteObj);
					quoteObj.setQuoteText("CONSUMER 6: " + quoteObj.getQuoteText());
