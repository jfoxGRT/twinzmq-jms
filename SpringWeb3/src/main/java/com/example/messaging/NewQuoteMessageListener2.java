...
@Component
public class NewQuoteMessageListener2 implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		if(message instanceof TextMessage) {
			...
			if(quoteObj != null){
				try{
					log.debug("From CONSUMER 2, saving: " + quoteObj);
					quoteObj.setQuoteText("CONSUMER 2: " + quoteObj.getQuoteText());
